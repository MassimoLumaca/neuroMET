...
# Load the data
data_wmi = pd.read_csv('PercentageTotalMETScore2SCfrontoparietalnetworkTable.csv')
...
plt.savefig('FrontoParietal_percentageTOTMET_SC_Heatmap.pdf', format='pdf', bbox_inches='tight')  # Save the heatmap as a PDF figure
plt.show()
