...
# Load the data
data_wmi = pd.read_csv('PercentageTotalMETScore2SCvisualnetworkTable.csv')
...
plt.savefig('Visual_percentageTOTMET_SC_Heatmap.pdf', format='pdf', bbox_inches='tight')  # Save the heatmap as a PDF figure
plt.show()
