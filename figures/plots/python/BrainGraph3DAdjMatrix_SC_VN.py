...
def plot_connectome(matrix, coordinates, node_sizes, node_colors):
    ...
    view = plotting.view_connectome(matrix, coordinates, node_size=node_sizes, edge_cmap='Greens', edge_threshold='0%', colorbar=True)
    view.open_in_browser()

if __name__ == "__main__":
    adjacency_matrix = load_adjacency_matrix('AvAdjacencyMatprop_structural.visual.mat', 'Csym')
...
def plot_matrix_heatmap(matrix, indices):
    ...
    # Plot heatmap
    plt.imshow(subset_matrix, cmap='Greens', interpolation='nearest')
    plt.colorbar()
...
if __name__ == "__main__":
    ...
    desired_indices = [1, 18, 19, 20, 21, 41, 58, 64, 75, 92, 93, 94, 95, 115, 132, 138]  # Python uses 0-based indexing
