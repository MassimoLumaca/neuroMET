...
if __name__ == "__main__":
    adjacency_matrix = load_adjacency_matrix('AvAdjacencyMatprop_structural.mat', 'Csym')
...
if __name__ == "__main__":
    adjacency_matrix = load_adjacency_matrix('AvAdjacencyMatprop_structural.FPN.mat', 'Csym')
