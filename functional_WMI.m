% -------------------------------------------------------------------------------------------------------------------
% MATLAB SCRIPT FOR GRAPH THEORY ANALYSIS IN FUNCTIONAL CONNECTOMES AND
...
% investigate the correlations between neural network metrics and WMI scores from WAIS-IV. 
%
% Key Features:
...
%% Remove participants
% Remove participants with NaN in their WAIS scores
idx2rem=[35 36 83 181 210 211 213:224 226:228 230 232:234 236:241];
% Remove participants according to outlier analysis
if strcmp(removeparticipant,'yes')
    ...
    removepp=[removepp idx2rem];
    removepp=sort(removepp,'ascend');
end
%% Load connectomes 
...
load('Index_Var_functional_iq.mat')
...
%% Create a table with F-values for the results. It will be used to create a heatmap (Suppl. Tables 9-10)
...
clearvars -except results stats target_net